package com.projak.amqc.plugin;
 ...
 * <p>
 */
public class AadhaarMaskingPlugin extends Plugin {
	...
	public String getScript() {
		return "AadhaarMaskingPlugin.js";
	}
	...
	public String getDojoModule() {
		return "aadhaarMaskingPluginDojo";
	}
	...
	public String getCSSFileName() {
		return "AadhaarMaskingPlugin.css";
	}
	...
	public String getConfigurationDijitClass() {
		return "aadhaarMaskingPluginDojo.ConfigurationPane";
	}
	...
	/**
	    ...
	    public PluginFeature[] getFeatures() {
	    	if (pluginFeatures.length == 0) {
				pluginFeatures = new PluginFeature[] {new com.projak.amqc.plugin.feature.QCFeature()};
			}
