define([
	...
	"dojo/text!./templates/QCFeature.html"
],
function(declare,Button,DateTextBox,parser,
		_LaunchBarPane,
		template) {
	/**
	 * @name aadhaarMaskingPluginDojo.QCFeature
	 * @class 
	 * @augments ecm.widget.layout._LaunchBarPane
	 */
	return declare("aadhaarMaskingPluginDojo.QCFeature", [
		_LaunchBarPane
	], {
		/** @lends aadhaarMaskingPluginDojo.QCFeature.prototype */
		...
		searchAmDcmts: function(){
			console.log("calling am document search function.");
